...
- **RF6.2.2 Selector de Dispositivo de Entrada:** Proveer en la sección de ajustes un control de lista desplegable que detecte y enumere dinámicamente los dispositivos de audio disponibles (interfaces externas, micrófonos, entradas de línea o bucles virtuales).
- **RF6.2.3 Re-conmutación en Tiempo Real:** Permitir el cambio entre dispositivos de entrada de audio en tiempo de ejecución sin requerir el reinicio de la aplicación ni la interrupción del hilo de renderizado gráfico.
