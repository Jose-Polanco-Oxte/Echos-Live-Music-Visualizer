...
* **Other templates** can be viewed in `.agents/skills/issues-writer/templates/`.
...
No issue validator script is currently shipped with this skill. Before saving an
issue, manually verify required fields, reproduction/acceptance criteria, links
and placeholder consistency against the selected template.
