...
description: >
  GPU frame debugging with RenderDoc via rdc-cli. Use this skill when the user mentions:
...
For the complete list of all 66 commands with arguments, options, types, and defaults, see [references/commands-quick-ref.md](references/commands-quick-ref.md).

For extended debugging recipes with expected output shapes, see [references/debugging-recipes.md](references/debugging-recipes.md).